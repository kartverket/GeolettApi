...
namespace GeolettApi.Application.Services.Authorization
{
    public class AuthorizationService : IAuthorizationService
    {
            ...
            ILogger<AuthorizationService> logger)
        {
            ...
            {
                new ActivityAccess(UserActivity.CreateRegisterItem, new List<string> { GeonorgeRole.Admin }),
                new ActivityAccess(UserActivity.UpdateRegisterItem, new List<string> { GeonorgeRole.Admin }),
                new ActivityAccess(UserActivity.DeleteRegisterItem, new List<string> { GeonorgeRole.Admin }),
            };
        }
